...
public	mouse_gene	public	select	{"filter": {}, "columns": ["id", "ensembl_chromosome", "ensembl_gene_acc_id", "ensembl_start", "ensembl_stop", "ensembl_strand", "entrez_gene_acc_id", "genome_build", "mgi_gene_acc_id", "name", "mgi_chromosome", "mgi_start", "mgi_stop", "mgi_strand", "ncbi_start", "ncbi_stop", "ncbi_strand", "symbol", "type", "subtype"], "allow_aggregations": true}	\N	f
