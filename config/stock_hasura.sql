...
public	mgi_disease	anonymous	select	{"filter": {}, "columns": ["disease_name", "do_acc_id", "entrez_acc_id", "mgi_gene_acc_id", "omim_acc_ids", "organism_name", "symbol", "taxon_acc_id"], "computed_fields": [], "allow_aggregations": true}	\N	f
